...
import 'package:mynotesh/utilities/dialogs/error_dialog.dart';
import 'package:mynotesh/utilities/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                'If you forget your password ,simply enter your email and we will send you a password',
              ),
              TextField(
